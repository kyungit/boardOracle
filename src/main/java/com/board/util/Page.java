...
public String getSysMemberList(int pageNum, int postNum, int pageListCount, int totalCount, String keyword) {
		...
		if(totalPage != 1) {
			...
			for(int i=1;i<=pageListCount;i++) {
				...
				// - i == 1 
				if(section >1 && i ==1)
					pageList += " <a href=sysMember?page=" + Integer.toString((section-2)*pageListCount + pageListCount) 
					+ "&keyword=" + keyword + ">◀</a>";
				//2. 페이지 출력 중단
				if(totalPage < (section-1)*pageListCount+i) { break; } 
				//3. 인자로 가져 온 페이지값과 계산해서 나온 페이지값이 같으면 링크를 안 붙이고 다르면 다른 페이지로 이동할수 있는 링크를 붙임.
				if(pageNum != (section-1)*pageListCount +i)
					pageList += " <a href=sysMember?page=" + Integer.toString((section-1)*pageListCount+i) 
							+ "&keyword=" + keyword + ">" + Integer.toString((section-1)*pageListCount+i) + "</a>";		
				else 
					pageList += " <span style='font-weight: bold'>" + Integer.toString((section-1)*pageListCount+i) + "</span>";
				//4.▶ 출력 조건
				...
				// totalPage >= i+(section-1)*pageListCount+1 --> 아직까지 출력할 페이지가 남아 있음.
				if(i==pageListCount && totalSection > 1 && totalPage >= i+(section-1)*pageListCount+1)
					pageList += " <a href=sysMember?page=" + Integer.toString(section*pageListCount+1) + "&keyword=" + keyword + ">▶</a>";
...
public String getSysBoardList(int pageNum, int postNum, int pageListCount, int totalCount, String keyword) {
		...
		if(totalPage != 1) {
			...
			for(int i=1;i<=pageListCount;i++) {
				...
				// - i == 1 
				if(section >1 && i ==1)
					pageList += " <a href=sysBoard?page=" + Integer.toString((section-2)*pageListCount + pageListCount) 
					+ "&keyword=" + keyword + ">◀</a>";
				//2. 페이지 출력 중단
				if(totalPage < (section-1)*pageListCount+i) { break; } 
				//3. 인자로 가져 온 페이지값과 계산해서 나온 페이지값이 같으면 링크를 안 붙이고 다르면 다른 페이지로 이동할수 있는 링크를 붙임.
				if(pageNum != (section-1)*pageListCount +i)
					pageList += " <a href=sysBoard?page=" + Integer.toString((section-1)*pageListCount+i) 
							+ "&keyword=" + keyword + ">" + Integer.toString((section-1)*pageListCount+i) + "</a>";		
				else 
					pageList += " <span style='font-weight: bold'>" + Integer.toString((section-1)*pageListCount+i) + "</span>";
				//4.▶ 출력 조건
				...
				// totalPage >= i+(section-1)*pageListCount+1 --> 아직까지 출력할 페이지가 남아 있음.
				if(i==pageListCount && totalSection > 1 && totalPage >= i+(section-1)*pageListCount+1)
					pageList += " <a href=sysBoard?page=" + Integer.toString(section*pageListCount+1) + "&keyword=" + keyword + ">▶</a>";
...
public String getSysReplyList(int pageNum, int postNum, int pageListCount, int totalCount, String keyword) {
		...
		if(totalPage != 1) {
			...
			for(int i=1;i<=pageListCount;i++) {
				...
				// - i == 1 
				if(section >1 && i ==1)
					pageList += " <a href=sysReply?page=" + Integer.toString((section-2)*pageListCount + pageListCount) 
					+ "&keyword=" + keyword + ">◀</a>";
				//2. 페이지 출력 중단
				if(totalPage < (section-1)*pageListCount+i) { break; } 
				//3. 인자로 가져 온 페이지값과 계산해서 나온 페이지값이 같으면 링크를 안 붙이고 다르면 다른 페이지로 이동할수 있는 링크를 붙임.
				if(pageNum != (section-1)*pageListCount +i)
					pageList += " <a href=sysReply?page=" + Integer.toString((section-1)*pageListCount+i) 
							+ "&keyword=" + keyword + ">" + Integer.toString((section-1)*pageListCount+i) + "</a>";		
				else 
					pageList += " <span style='font-weight: bold'>" + Integer.toString((section-1)*pageListCount+i) + "</span>";
				//4.▶ 출력 조건
				...
				// totalPage >= i+(section-1)*pageListCount+1 --> 아직까지 출력할 페이지가 남아 있음.
				if(i==pageListCount && totalSection > 1 && totalPage >= i+(section-1)*pageListCount+1)
					pageList += " <a href=sysReply?page=" + Integer.toString(section*pageListCount+1) + "&keyword=" + keyword + ">▶</a>";
...
//관리자모드에서 멤버별 게시글 통계
public String getSystemBoard(int pageNum, int postNum, int pageListCount, int totalCount, String keyword) {
		...
		if(totalPage != 1) {
			...
			for(int i=1;i<=pageListCount;i++) {
				...
				// - i == 1 
				if(section >1 && i ==1)
					pageList += " <a href='javascript:void(0);' onclick='statsBoardPage("+  Integer.toString((section-2)*pageListCount + pageListCount) +")"
					+ ">◀</a>";
				//2. 페이지 출력 중단
				if(totalPage < (section-1)*pageListCount+i) { break; } 
				//3. 인자로 가져 온 페이지값과 계산해서 나온 페이지값이 같으면 링크를 안 붙이고 다르면 다른 페이지로 이동할수 있는 링크를 붙임.
				if(pageNum != (section-1)*pageListCount +i)
					pageList += " <a href='javascript:void(0);' onclick='statsBoardPage(" + Integer.toString((section-1)*pageListCount+i) +")"
							+"</a>";		
				else 
					pageList += " <span style='font-weight: bold'>" + Integer.toString((section-1)*pageListCount+i) + "</span>";
				//4.▶ 출력 조건
				...
				// totalPage >= i+(section-1)*pageListCount+1 --> 아직까지 출력할 페이지가 남아 있음.
				if(i==pageListCount && totalSection > 1 && totalPage >= i+(section-1)*pageListCount+1)
					pageList += " <a href=statsBoard?page=" + Integer.toString(section*pageListCount+1) + ">▶</a>";
